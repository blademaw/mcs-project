...
\begingroup%
  ...
  \begin{picture}(1,1.00000014)%
    ...
    \put(0.15604698,0.075183337){\color[rgb]{0,0,0}\makebox(0,0)[t]{\lineheight{1.25}\smash{\begin{tabular}[t]{c}field site\end{tabular}}}}%
    ...
    \put(0.2609477,0.1993703){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\large\textbf{(i)}\end{tabular}}}}%
    \put(0.63007673,0.54175073){\color[rgb]{0,0,0}\makebox(0,0)[rt]{\lineheight{1.25}\smash{\begin{tabular}[t]{r}\large\textbf{(ii)}\end{tabular}}}}%
    \put(0.71797428,0.92242789){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\large\textbf{(iii)}\end{tabular}}}}%
    \put(0.59797428,0.18242789){\color[rgb]{0,0,0}\makebox(0,0)[lt]{\lineheight{1.25}\smash{\begin{tabular}[t]{l}\large\textbf{(iv)}\end{tabular}}}}%
  \end{picture}%
\endgroup%